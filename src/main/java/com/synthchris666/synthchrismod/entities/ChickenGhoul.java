...
public class ChickenGhoul extends MonsterEntity {
	 /** The attribute which determines the chance that this mob will spawn reinforcements */
	   ...
	   public ChickenGhoul(EntityType<? extends ChickenGhoul> type, World worldIn) {
	      super(type, worldIn);
	   }

	   public ChickenGhoul(World worldIn) {
	      this(ModEntityTypes.CHICKEN_GHOUL.get(), worldIn);
	   }

	   protected void registerGoals() {
	      this.goalSelector.addGoal(4, new ChickenGhoul.AttackTurtleEggGoal(this, 1.0D, 3));
	   ...
	   protected void registerAttributes() {
	      ...
	      this.getAttribute(SharedMonsterAttributes.FOLLOW_RANGE).setBaseValue(500.0D);
	   ...
	   protected void onDrowned() {
	      this.func_213698_b(ModEntityTypes.CHICKEN_GHOUL.get());
	      this.world.playEvent((PlayerEntity)null, 1040, new BlockPos(this), 0);
	   }

	   protected void func_213698_b(EntityType<? extends ChickenGhoul> p_213698_1_) {
	      if (!this.removed) {
	         ChickenGhoul zombieentity = p_213698_1_.create(this.world);
	   ...
	   protected SoundEvent getAmbientSound() {
	      return SoundInit.ENTITY_CHICKEN_GHOUL_AMBIENT.get();
	   }

	   protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
	      return SoundInit.ENTITY_CHICKEN_GHOUL_HURT.get();
	   }

	   protected SoundEvent getDeathSound() {
	      return SoundInit.ENTITY_CHICKEN_GHOUL_DEATH.get();
	   }
	   ...
	   public void onKillEntity(LivingEntity entityLivingIn) {
	      ...
	      if ((this.world.getDifficulty() == Difficulty.NORMAL || this.world.getDifficulty() == Difficulty.HARD) && entityLivingIn instanceof VillagerEntity) {
	         ...
	         zombievillagerentity.onInitialSpawn(this.world, this.world.getDifficultyForLocation(new BlockPos(zombievillagerentity)), SpawnReason.CONVERSION, new ChickenGhoul.GroupData(false), (CompoundNBT)null);
	   ...
	   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
	      ...
	      if (spawnDataIn == null) {
	         spawnDataIn = new ChickenGhoul.GroupData(worldIn.getRandom().nextFloat() < net.minecraftforge.common.ForgeConfig.SERVER.zombieBabyChance.get());
	      }
	   ...
	   class AttackTurtleEggGoal extends BreakBlockGoal {
	      ...
	      public void playBreakingSound(IWorld worldIn, BlockPos pos) {
	         worldIn.playSound((PlayerEntity)null, pos, SoundEvents.ENTITY_ZOMBIE_DESTROY_EGG, SoundCategory.HOSTILE, 0.5F, 0.9F + ChickenGhoul.this.rand.nextFloat() * 0.2F);
	      }
