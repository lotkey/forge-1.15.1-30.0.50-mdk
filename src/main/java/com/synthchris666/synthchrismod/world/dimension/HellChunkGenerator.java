...
public class HellChunkGenerator extends NoiseChunkGenerator<HellGenSettings> {
   ...
   public HellChunkGenerator(IWorld worldIn, BiomeProvider provider, HellGenSettings settingsIn) {
