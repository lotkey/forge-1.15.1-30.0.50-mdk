...
public class ChickenDimension extends Dimension{

	public ChickenDimension(World world, DimensionType type) {
		super(world, type, 0.0f);
	}

	@Override
	public ChunkGenerator<?> createChunkGenerator() {
		return new ChickenChunkGenerator(world, new ChickenBiomeProvider(), new ChickenGenSettings());
	}
